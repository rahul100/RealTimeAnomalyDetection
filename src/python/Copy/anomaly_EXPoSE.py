...
def parse_args():
	...
	parser.add_argument('--decay', type=float, required=False, default=0.005,help='sliding window')
...
while(1):
	...
	query = 'select value from ' + measurement + ' where time > now() - ' + str(chunksize)  + 's;'
	#print query
